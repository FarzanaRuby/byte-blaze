        ...
        <div>
            <div className="navbar bg-base-100 shadow-lg px-4 ">
                <div className="flex-1">
                    <Link to={'/'} className="btn btn-ghost text-2xl text-secondary gap-0 font-bold">Byte <span className="text-primary text-3xl">Blaze</span></Link>
                </div>
                <div className="flex-none">

                    <ul className="menu menu-horizontal px-1 hidden sm:flex items-center gap-4">
                        <NavLink to={'/'} className={({ isActive }) => isActive ?
                            " text-secondary font-bold" : "font-bold"} >Home</NavLink>
                        
                        <NavLink to={'/blogs'} className={({ isActive }) => isActive ?
                            " text-secondary font-bold" : "font-bold"} >Blogs</NavLink>      

                             <NavLink to={'/bookmarks'} className={({ isActive }) => isActive ?
                            " text-secondary font-bold" : "font-bold"}>Bookmarks</NavLink>  
